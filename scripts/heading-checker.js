  ...
  (function() {
    ...
    function parse(options) {
      ...
      for (; i < options.length; i++) {
        ...
        output = output + ('<span class="level" data-level="' + data.level + '"></span> ');
    ...
    var shrinkChildStyle = "position: fixed; top: 0; right: 0; max-height: 100%; box-shadow: 0 0 80px rgba(0,0,0,0.3); width: 20%; min-width: 320px; max-width: 450px; z-index: 1000001;";
    var imgElement = document.createElement("DIV");
    imgElement.id = "h1-a11y-highlighterelement";
    imgElement.style.cssText = "pointer-events: none; position: fixed; border: 1px dashed #0081BE; box-shadow: 0 0 54px 0 rgba(0,84,150,0.3); display: none; z-index: 1000000; transition: all 200ms;";
